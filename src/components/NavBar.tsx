...
export default function Card() {
  return (
    <div className="flex h-fit items-center border-b border-stone-600 w-full sticky-top justify-evenly dark:bg-black mt-5">
      <NavLink
        to="/"
        className={({ isActive }) =>
          isActive
            ? "flex w-full justify-center items-center border-b-4 border-gray-900 dark:border-gray-100"
      ...
      >
        <div className="flex flex-row items-center my-2">
          ...
          <span className="m-2 text-sm hidden sm:block font-medium">
            Home
          </span>
        </div>
      </NavLink>
      ...
      >
        <div className="flex flex-row items-center">
          ...
          <span className="m-2 text-sm hidden sm:block font-medium">CV</span>
        </div>
      </NavLink>
      <NavLink
        to="contact"
