...
export default function Landing() {
  return (
    <div
      className={`flex py-20 flex-col flex-grow items-center justify-center `}
    >
      <h1 className="font-extrabold text-transparent text-8xl bg-clip-text bg-gradient-to-r from-purple-800 to-red-400">
        TODO:
      </h1>
