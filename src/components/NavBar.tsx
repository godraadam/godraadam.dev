...
export default function Card() {
  ...
  return (
    <div className={`flex h-fit border-b border-stone-600 w-full sticky-top justify-evenly dark:bg-black`}>
        <Link to={`/`}>
          <button
            className={`p-4 ${
        ...
        <Link to={`about`}>
          ...
          >
            <div className="flex flex-row items-center">
              ...
              <span className="m-2 text-sm font-medium">About me</span>
            </div>
          </button>
        </Link>
        <Link to="cv">
          ...
          >
            <div className="flex flex-row items-center">
              ...
              <span className="m-2 text-sm font-medium">CV</span>
            </div>
          </button>
        </Link>
        <Link to="contact">
          ...
          >
            <div className="flex flex-row items-center">
              ...
              <span className="m-2 text-sm font-medium">Contact</span>
            </div>
          </button>
        </Link>
    </div>
